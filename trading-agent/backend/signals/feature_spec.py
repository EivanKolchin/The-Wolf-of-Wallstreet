...
INPUT = BASE + HTF + NEWS_EMBED = 86  (the model's input_size)
"""
...
# 70..85, growing INPUT 70 → 86. Older checkpoints hard-fail in
# model_io.load_checkpoint and cold-start (the model is being retrained anyway).

BASE = 62
HTF = 8
NEWS_EMBED_DIM = 16
INPUT = BASE + HTF + NEWS_EMBED_DIM  # 86
...
NEWS_EMBED = slice(NEWS_EMBED_START, INPUT)      # [70:86] — 16-dim semantic news embedding
